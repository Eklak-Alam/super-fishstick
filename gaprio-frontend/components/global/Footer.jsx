        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 mb-24">
          ...
          <div className="lg:col-span-7 grid grid-cols-2 md:grid-cols-3 gap-8 lg:gap-12 mt-4 lg:mt-0">
            ...
            <div className="flex flex-col gap-4">
                <h4 className="text-white font-bold tracking-wide text-sm uppercase opacity-80">Platform</h4>
            ...
            {/* Column 3 */}
            <div className="flex flex-col gap-4">
                <h4 className="text-white font-bold tracking-wide text-sm uppercase opacity-80">Legal</h4>
                <ul className="space-y-3">
...
function FooterLink({ children }) {
    return (
        <li>
            <Link href="#" className="group flex items-center gap-1 text-zinc-500 hover:text-white transition-colors text-sm font-medium">
                <span>{children}</span>
                <ArrowUpRight size={12} className="opacity-0 -translate-y-1 translate-x-1 group-hover:opacity-100 group-hover:translate-y-0 group-hover:translate-x-0 transition-all duration-300 text-orange-500" />
            </Link>
        </li>
    )
}
