...
export default function Footer() {
  ...
  // 0% -> Shows Panel 1 (Gaprio Text)
  // 100% -> Shows Panel 2 (Links)
  ...
  return (
    // Height 250vh creates the scroll space.
    // suppressHydrationWarning added for safety.
    <section ref={targetRef} className="relative h-[250vh] bg-[#020202]" suppressHydrationWarning>
      
      {/* Sticky Container: Locks the view for the horizontal slide */}
      <div className="sticky top-0 flex h-screen items-center overflow-hidden">
        
        {/* The Track: 200vw wide (2 Panels) */}
        <motion.div style={{ x }} className="flex w-[200vw]">
          
          {/* --- PANEL 1: THE BRAND REVEAL (First) --- */}
          <div className="w-screen h-screen relative flex flex-col items-center justify-center overflow-hidden bg-[#020202] border-r border-white/5">
              
              {/* Horizon Light (Mobile adjusted size) */}
              ...
              {/* Scroll Indicator */}
              <div className="absolute bottom-8 md:bottom-12 right-6 md:right-12 flex items-center gap-2 md:gap-3 animate-pulse opacity-50">
                  <span className="text-[10px] md:text-xs font-mono text-zinc-500 uppercase tracking-widest">Scroll</span>
                  <ArrowRight size={14} className="text-zinc-500" />
              </div>
          </div>


          {/* --- PANEL 2: LINKS & SOCIALS (Second) --- */}
          <div className="w-screen h-screen flex flex-col justify-center items-center px-6 md:px-20 relative bg-[#020202]">
             ...
             {/* Grid: 2 Columns on Mobile (to save height), 12 on Desktop */}
